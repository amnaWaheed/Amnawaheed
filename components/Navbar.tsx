...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 ${
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="md:hidden">
            <button
              ...
              className="p-2 rounded-md text-slate-300 hover:text-orange-400 hover:bg-slate-800"
            >
      ...
      {/* Mobile Nav */}
      <div className={`md:hidden absolute w-full bg-[#0f172a] transition-all duration-300 ease-in-out ${
